...
const FilterStatusProfilePage = ({ selectedStatus, onChangeStatus }) => {
  ...
  return (
    <div className="relative flex items-center z-20 mt-6">
      <div className="flex lg:mr-14 mr-2 mb-5 gap-2 lg:mt-0">
        <button
          type="button"
        ...
        {isOpen && (
          <div
            ref={filterRef}
            className="absolute top-6 -right-1 w-[151px] h-[271px] lg:w-[211px] lg:h-[355px] bg-clara4 border border-cinza6 rounded-md shadow-md p-4 z-[9999] "
          >
            <p className="lg:w-[93px] text-texto2 lg:text-[17px] text-[10px] font-normal font-['Open Sans'] tracking-tight underline mt-1">
              Pagamentos
            </p>
            ...
            <div className="flex items-center lg:w-auto text-texto2 lg:text-[15px] text-[10px] font-normal font-['Open Sans'] tracking-tight lg:mt-0 mt-2">
              <input
                type="checkbox"
                id="pago"
            ...
            <div className="flex items-center lg:w-auto text-texto2 lg:text-[15px] text-[10px] font-normal font-['Open Sans'] tracking-tights lg:mt-0 mt-1">
              <input
                type="checkbox"
                id="parcial"
            ...
            <div className="flex items-center lg:w-autolg:w-[124px] text-texto2 lg:text-[15px] text-[10px] font-normal font-['Open Sans'] tracking-tight lg:mt-1 mt-2">
              <input
                type="checkbox"
                id="nao-realizada"
            ...
            <button
              type="submit"
              onClick={apllyFIlter}
              className="flex mt-3 mx-auto lg:h-6 h-[17.16px] px-6 lg:py-0.5 py-1 bg-primaria rounded-[100px] text-white lg:text-sm text-[8px] font-semibold  shadow-[0px_1px_2px_0px_rgba(0,0,0,0.30)]"
            >
              Filtrar
            </button>
          </div>
