...
const ProfileCustomerPage = () => {
  ...
  return (
    <div className="container mx-auto px-8 mt-24 ">
      <div className="flex lg:flex-nowrap flex-wrap  justify-center items-start gap-6">
        <div className="relative lg:lg:w-[48%] md:w-[90%] max-w-[95%]  w-[calc(90vw)] lg:h-[449px] h-auto bg-bg1 shadow p-6 lg:border-2 border border-cinza6 rounded-[15px] text-F15 mt-4">
          ...
          <h2 className="lg:text-F25 text-sm font-medium mb-4 text-primaria lg:ml-5">
            Conta do paciente
          </h2>
          <div>
        ...
        >
          ...
          {isEditingMessage ? (
            ...
            <ul className="mt-4 list-disc list-inside lg:text-F17 text-sm text-texto1">
