  ...
  return (
    <div className="fixed inset-0 bg-bgM/30 bg-opacity-50 backdrop-blur-sm flex justify-center items-start z-30">
      <div className="bg-bg1 rounded-B15 p-6 w-[90%] sm:w-[400px] lg:w-[477px] max-h-[90vh] lg:h-[521px] border border-cinza6 lg:border-[3px] mt-[18vh] flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-4 lg:ml-8">
          <button
            onClick={onSendEmail}
            className="w-full h-auto px-4 py-2 bg-bg1 rounded-[100px] border border-primaria text-primaria text-sm font-semibold text-center lg:text-sm text-[10px]"
          >
            Enviar por Email
          </button>
          <button
