          ...
          <div className="flex w-auto lg:p-6 p-1 rounded-[8px] border-2 border-solid border-primaria flex-col items-center justify-center">
            ...
            {calendars.map((calendar) => (
              ...
              >
                <input
                  type="checkbox"
                  class="appearance-none lg:w-[20px] lg:h-[20px] w-[16px] h-[16px] rounded-full border-2 border-primaria checked:border-primaria checked:bg-white checked:relative checked:before:content-[''] checked:before:absolute checked:before:inset-0 checked:before:m-auto lg:checked:before:w-[10px] checked:before:w-[7px] lg:checked:before:h-[10px] checked:before:h-[7px] checked:before:rounded-full checked:before:bg-primaria ml-5 mr-3 cursor-pointer"
                  name="calendar"
