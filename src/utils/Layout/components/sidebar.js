...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  return (
    <>
      <aside
        className={`max-md:fixed top-0 z-30 left-0 h-full w-[265px] bg-bg1 p-5 text-gray-800 transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"
